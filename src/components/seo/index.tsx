...
export default function Seo(seoProps:SeoProps):ReactElement {
  ...
  return (
    <Head>
      <title>{title}</title>
      <meta name='robots' content={seoProps.robots} />
      <meta content={description} name='description' />
      <meta property='og:url' content={`${url}${router.asPath}`} />
      <link rel='canonical' href={`${seoProps.url}${router.asPath}`} />

      {/* Open Graph */}
      <meta property='og:type' content={seoProps.type} />
      <meta property='og:site_name' content={seoProps.siteName} />
      <meta property='og:description' content={description} />
      <meta property='og:title' content={title} />
      <meta name='image' property='og:image' content={seoProps.image} />
